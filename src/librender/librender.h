...
int	render_osx(void *osx);
int	render_osy(void *osy);
int	render_blocksize(void *self);

//Setters
void	render_set_state(void *self, int state);
void	render_set_osx(void *self, int osx);
void	render_set_osy(void *self, int osy);
void	render_set_blocksize(void *self, int blocksize);
